CREATE TABLE tx_entity_domain_model_entity (
	...
	tx_entitybicyclemarket_frame_size varchar(255) DEFAULT '' NOT NULL,
	...
	tx_entitybicyclemarket_discount_price double(11,2) DEFAULT '0.00' NOT NULL,
	...
	tx_entitybicyclemarket_item_number varchar(255) DEFAULT '' NOT NULL
);
